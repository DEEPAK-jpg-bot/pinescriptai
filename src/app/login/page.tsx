        ...
        <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 px-4 font-sans text-slate-900">
            <div className="w-full max-w-[400px] space-y-8">
                <div className="flex flex-col items-center gap-2 text-center">
                    ...
                    <p className="text-slate-500">Sign in with your preferred provider</p>
                </div>
                ...
                <div className="bg-white p-8 rounded-xl shadow-xl border border-slate-200">
                    <div className="space-y-3">
                        ...
                        >
                            ...
                            <span className="ml-10">Continue with GitHub</span>
                        </Button>
                        ...
                        >
                            ...
                            <span className="ml-10">Continue with Microsoft</span>
                        </Button>

                        <Button
                            variant="outline"
                            className="w-full h-12 justify-start pl-4 text-base font-normal bg-black hover:bg-black/90 text-white border-transparent relative"
                        ...
                        >
                            {loading === 'apple' ? (
                                ...
                                <Apple className="absolute left-4 w-5 h-5" />
                            )}
                            <span className="ml-10">Continue with Apple</span>
                        </Button>
                    </div>
                    ...
                    <p className="text-center text-xs text-slate-400">
                        By continuing, you verify that you are a real human and agree to our Terms of Service.
